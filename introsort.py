...
# Introsort function (using Python's built-in sort)
def introsort(array):
    array.sort()
...
output_file_path = r'C:\Users\david\OneDrive\Masters\Assignments\Programming Assignment\introsort_output.txt'
...
try:
    ...
    # Call the introsort function (using Python's built-in sort)
    introsort(data)
    ...
    print("Sorting completed. Check introsort_output.txt for the result.")
